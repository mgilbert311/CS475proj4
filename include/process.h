...
/* Maximum number of processes in the system was 100*/
...
struct procent {		/* entry in the process table		*/
	pri16 	prprio;			/* Stores the priority of the process */
	pri16 	prprioOld;	/* Store the original priority for aging policy */
